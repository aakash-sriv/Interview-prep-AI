...
const RoleInfoHeader = ({
  ...
  return <div className='bg-white relative dark:bg-gray-400'>
    <div className='container mx-auto px-10 md:px-0'>
        ...
        <div className='w-[40vw] md:w-[30vw] h-[200px] flex items-center justify-center bg-white overflow-hidden absolute top-0 right-0'>
            ...
            <div className='w-16 h-16 bg-fuchsia-200 blur-[45px] animate-blfob1'/>
        </div>
    </div>
  </div>
}
...
const RoleInfoHeader = ({
  ...
  return <div className={`relative ${darkMode ? 'bg-gray-400' : 'bg-white'}`}>
    <div className='container mx-auto px-10 md:px-0'>
        <div className='h-[200px] flex flex-col justify-center relative z-10'>
            <div className='flex items-start'>
                <div className='flex-grow'> 
        ...
        <div className={`w-[40vw] md:w-[30vw] h-[200px] flex items-center justify-center overflow-hidden absolute top-0 right-0 ${darkMode ? 'bg-gray-400' : 'bg-white'}`}>
            <div className='w-16 h-16 bg-lime-400 blur-[65px] animate-blob1'/>
            <div className='w-16 h-16 bg-teal-400 blur-[65px] animate-blob2'/>
            <div className='w-16 h-16 bg-cyan-300 blur-[45px] animate-blob3'/>
            <div className='w-16 h-16 bg-fuchsia-200 blur-[45px] animate-blfob1'/>
