...
const QuestionCard = ({
  ...
  return <>
        <div className='card-theme rounded-lg mb-4 overflow-hidden py-4 px-5 border border-theme-secondary group'>
            <div className='flex items-start justify-between cursor-pointer'>
                <div className='flex items-start gap-3.5'>
                    <span className='text-xs md:text-[15px] font-semibold text-theme-muted leading-[18px]'>
                        Q
                    </span>

                    <h3
                        className='text-xs md:text-[14px] font-medium text-theme-primary mr-0 md:mr-20'
                        onClick={toggleExpand}
                    >
                        {question}
                    </h3>
                ...
                <div className='flex items-center justify-end ml-4 relative'>
                    ...
                    <button
                        className='text-theme-muted hover:text-theme-tertiary cursor-pointer'
                        onClick={toggleExpand}
                    >
                        <LuChevronDown 
                            size={20}
            ...
            >
                <div
                    ref={contentRef}
                    className='mt-4 text-theme-secondary px-5 py-3 rounded-lg'
                    style={{ backgroundColor: 'var(--color-question-bg)' }}
                >
                    <AIResponsePreview content={answer} />
                </div>               
            </div>
