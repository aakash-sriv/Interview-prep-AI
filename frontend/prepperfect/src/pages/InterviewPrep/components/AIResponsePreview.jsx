                    ...
                    table({children , href}) {
                        return (
                            <div className='overflow-x-auto my-4'>
                                <table className='min-w-full divide-gray-300 border-gray-200'>
                                    {children}
                                </table>
                            </div>
                        );
...
function CodeBlock ({ code , language }) {
    ...
    return <div className='relative my-6 rounded-lg overflow-hidden bg-gray-50 border border-b-gray-200'>
